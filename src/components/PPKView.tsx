          ...
          <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-slate-100 rounded-[2rem] overflow-hidden bg-slate-50 h-[400px]">
                  {selectedRequest.attachmentData ? (
                    <PDFPreview data={selectedRequest.attachmentData} />
                  ) : (
                    <div className="w-full h-full flex items-center justify-center text-slate-400 italic text-xs">Pratinjau tidak tersedia</div>
                  )}
                </div>
              </div>
