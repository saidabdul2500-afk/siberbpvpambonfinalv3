...
import { FileSearch, CheckCircle2, UploadCloud, RotateCcw, BarChart3 } from 'lucide-react';
...
const OrganizerManual: React.FC = () => {
  const steps = [
    { 
      number: 1, 
    ...
    { 
      ...
      description: 'Tekan "TERUSKAN KE TU" jika usulan sudah sesuai.', 
      icon: CheckCircle2 
    },
    { 
      number: 3, 
    ...
    { 
      number: 5, 
      title: 'Monitoring', 
      description: 'Cek status secara berkala di menu "Riwayat".', 
      icon: BarChart3 
    },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
        <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-4">Informasi Penting Penyelenggara</h4>
        <div className="space-y-3">
          <p className="text-[11px] font-bold text-slate-500 leading-relaxed">
            • Penyelenggara bertanggung jawab atas verifikasi teknis kesesuaian bahan pelatihan.
          </p>
          <p className="text-[11px] font-bold text-slate-500 leading-relaxed">
            • Pastikan dokumen yang diunggah adalah dokumen yang telah ditandatangani secara sah sebelum diteruskan ke TU.
          </p>
        </div>
      </div>
    </div>
...
export default OrganizerManual;
